//
// Created by oscar on 09/04/2022.
//

#ifndef ESTRUCTURA_DATOS_DINAMIC_LIST_H
#define ESTRUCTURA_DATOS_DINAMIC_LIST_H

//en vez de int poñer os datos correspondentes
#include <stdbool.h>
#define LNULL NULL
...
struct tNode{
    tItemL data;             //Conten un elemento
    tPosL next;              //Punteiro ao seguinte nodo
};
typedef tPosL tList;         //Definición de tipo de lista como punteiro a un nodo (primer elemenmto)
...
**********************************************************************************************/
bool insertItem(tItemL d,tPosL p,tList* L);//en vez de tItemL, poñemos int e creamos o typedef de tItemL como int
/**********************************************************************************************
...
#endif //ESTRUCTURA_DATOS_DINAMIC_LIST_H
